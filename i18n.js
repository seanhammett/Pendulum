...
const STRINGS = {
  en: {
    ...
    'arch.slide': 'Drag this bob along the chain. L{i} and L{j} share the difference between them, so the reach and every other bob stay where they are.',
    ...
    'export.png': 'PNG',
    'export.svg': 'SVG',
    'export.tip': 'First and last second of the flight cycle to save, from the most recent pass that has finished. Nothing is drawn but the traces and a small caption in the bottom corners — lengths and masses on the left, initial conditions on the right — and the background is transparent; SVG also keeps the parameters that produced the pattern in its description, PNG does not. The span is recorded separately from the trail above, so it can be saved from the moment it has been flown, whatever the trail Length is set to.',
    'export.auto': 'Auto',
  ...
  fr: {
    ...
    'arch.slide': 'Faire glisser cette bille le long de la chaîne. L{i} et L{j} se partagent la différence : la portée et les autres billes ne bougent pas.',
    ...
    'export.png': 'PNG',
    'export.svg': 'SVG',
    'export.tip': "Première et dernière seconde du cycle de vol à enregistrer, prises au dernier passage terminé. Rien n'est dessiné hormis les traces et une petite légende dans les coins inférieurs — longueurs et masses à gauche, conditions initiales à droite — et le fond est transparent ; le SVG conserve en outre dans sa description les paramètres qui ont produit le motif, le PNG non. La plage est enregistrée à part de la trace ci-dessus : elle peut donc être sauvegardée dès qu'elle a été parcourue, quelle que soit la durée de trace.",
    'export.auto': 'Auto',
