...
const STRINGS = {
  en: {
    ...
    'arch.double': 'Double',
    'arch.triple': 'Triple',
    'arch.links.tip': 'Number of linked rods in the selected pendulum: one is regular and predictable, two or three are chaotic. Changing it re-runs every pendulum from its initial conditions.',
    ...
    'arch.add': 'Add',
    'arch.add.tip': 'Hang another pendulum from the same pivot, slightly smaller than the last. They do not interact — a shared pivot is not a coupled system. Adding one restarts every pendulum from its initial conditions.',
    'arch.add.full': 'Three pendulums maximum.',
    'arch.remove': 'Remove this pendulum',
  ...
  fr: {
    ...
    'arch.double': 'Double',
    'arch.triple': 'Triple',
    'arch.links.tip': 'Nombre de segments articulés du pendule sélectionné : un seul est régulier et prévisible, deux ou trois sont chaotiques. Le modifier relance tous les pendules depuis leurs conditions initiales.',
    ...
    'arch.add': 'Ajouter',
    'arch.add.tip': "Suspendre un autre pendule au même point, un peu plus petit que le précédent. Ils n'interagissent pas — un point de suspension commun ne couple rien. En ajouter un relance tous les pendules depuis leurs conditions initiales.",
    'arch.add.full': 'Trois pendules au maximum.',
    'arch.remove': 'Retirer ce pendule',
